...
namespace CmlLib.Core
{
    public class MLaunch
    {
        ...
        public string[] CreateArg()
        {
            ...
            // logging
			var loggingClientArgument = version.LoggingClient?.Argument;
			if (!string.IsNullOrEmpty(loggingClientArgument))
                args.Add(Mapper.Interpolation(loggingClientArgument, new Dictionary<string, string?>()
                {
